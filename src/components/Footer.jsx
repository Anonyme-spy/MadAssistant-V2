			...
			<div className="footer__container">
				<div className="footer__content">
					...
					<div className="footer__nav">
						<a href="#" className="footer__nav-link">Accueil</a>
						<a href="#" className="footer__nav-link">Options</a>
						<a href="#" className="footer__nav-link">Avantages</a>
					...
					<div className="footer__social">
						...
						<a href="https://x.com/MadAssistant13" target="_blank" className="footer__social-link">
							<svg className="footer__social-icon" fill="currentColor" viewBox="0 0 24 24">
								<path
